...
// A signed URL for the browser to upload the turntable video (or its poster)
// straight to Storage. The file never passes through this route, so Vercel's
// request body limit does not apply; commit it with PATCH ../media.
