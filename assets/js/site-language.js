(() => {
  ...
  const enToTh = {
    ...
    "Production Note": "หมายเหตุสำหรับระบบจริง",
    "A real back office still needs secure admin login, a server database, payment webhooks, image uploads, and permission control.": "ระบบหลังบ้านจริงยังต้องมี admin login ที่ปลอดภัย ฐานข้อมูลบนเซิร์ฟเวอร์ payment webhook ระบบอัปโหลดรูป และการควบคุมสิทธิ์",
