(() => {
  ...
  const keyedTranslations = {
    en: {
      ...
      "hero.tagline": "Quietly elegant diamond jewelry for proposals, vows, and the intimate milestones held closest to the heart.",
      "hero.primary": "Find Your Engagement Ring",
      "hero.secondary": "Discover Maris",
      ...
      "collection.intro": "Find the piece that tells your story.",
      "collection.cta": "Shop Now",
      ...
      "collection.feature.cta": "View current pieces",
      "atelier.eyebrow": "Atelier Reveal",
      "atelier.title": "A quiet drawer opens inside Maris.",
      "atelier.text": "A read-only glimpse of published Supabase catalogue pieces, shaped for browsing and enquiry, never fake checkout.",
      "atelier.primary": "View catalogue",
      "atelier.secondary": "Ask Maris to confirm availability",
      "value.lead.eyebrow": "Maris Standard",
      "value.lead.title": "A quieter kind of precision.",
      "value.lead.text": "From one-off rings to partner production, every piece is treated as a small architecture of proportion, comfort, and finish.",
      ...
      "footer.join": "Join Us",
      "footer.joinText": "Receive exclusive updates & offers",
    ...
    th: {
      ...
      "hero.tagline": "เครื่องประดับเพชรที่เรียบหรูอย่างพอดี สำหรับคำขอแต่งงาน วันแต่งงาน และทุกช่วงเวลาพิเศษที่มีความหมายกับคุณ",
      "hero.primary": "ค้นหาแหวนหมั้นของคุณ",
      "hero.secondary": "รู้จัก Maris",
      ...
      "collection.intro": "เลือกชิ้นที่เหมาะกับเรื่องราวและสไตล์ของคุณ",
      ...
      "collection.feature.cta": "ดูแบบล่าสุด",
      "atelier.eyebrow": "เปิดถาด Atelier",
      "atelier.title": "ลิ้นชักเงียบ ๆ ของ Maris ค่อย ๆ เปิดออก",
      "atelier.text": "ภาพตัวอย่างแบบอ่านอย่างเดียวจากแคตตาล็อก Supabase สำหรับเลือกชมและติดต่อสอบถาม โดยไม่สร้าง checkout ปลอม",
      "atelier.primary": "ดูแคตตาล็อก",
      "atelier.secondary": "ให้ Maris ช่วยยืนยันสถานะสินค้า",
      "value.lead.eyebrow": "มาตรฐาน Maris",
      "value.lead.title": "ความประณีตที่ไม่ต้องส่งเสียงดัง",
      "value.lead.text": "ตั้งแต่งานแหวนเฉพาะชิ้นจนถึงงานผลิตสำหรับคู่ค้า ทุกชิ้นถูกดูแลด้วยสัดส่วน ความสบาย และผิวงานที่ละเอียด",
      ...
      "footer.joinText": "รับข่าวสารและข้อเสนอพิเศษ",
